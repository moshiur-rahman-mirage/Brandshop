        ...
        <div className='min-h-screen flex justify-center items-center '>
            <div>
                ...
                <div className='grid grid-cols-4 gap-5 '>
                    <div className="flex rounded-lg justify-center pl-2 items-center bg-body-color text-neutral-content">
                        <div className='text-black text-6xl'>
                            <AiOutlineHome />
                        </div>
                        <div className="card-body text-black text-right">
                            <h2 className="text-right font-bold">Free Shipping!</h2>
                            {/* <p>Free Shipping.</p> */}
                        </div>
                    </div>
                    ...
                    <div className="flex rounded-lg  justify-center pl-2 items-center bg-body-color text-neutral-content">
                        ...
                        <div className="card-body text-black text-right">
                            <h2 className="text-right font-bold">Fastest Delivery!</h2>
                        </div>
                    </div>
                    <div className="flex rounded-lg  justify-center pl-2 items-center bg-body-color text-neutral-content">
                        <div className='text-black text-6xl'>
                        ...
                        <div className="card-body text-black text-right">
                            <h2 className="text-right font-bold">24/7 Support!</h2>
                        </div>
                    </div>
                    ...
                    <div className="flex rounded-lg  justify-center pl-2 items-center bg-body-color text-neutral-content">
                        ...
                        <div className="card-body text-black text-right">
                            <h2 className="text-right">100% Refund!</h2>
